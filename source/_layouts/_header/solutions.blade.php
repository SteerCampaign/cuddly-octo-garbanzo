      ...
      <div class="grid grid-cols-2 md:grid-cols-10">
        <div class="md:col-span-5">
          <div class="flex flex-col py-6 px-3 md:px-6">
            <div class="space-y-4">
              <a class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="/solutions/small-businesses/">
                ...
                <div class="grow">
                <p class="font-medium text-gray-800 dark:text-gray-200">Small Businesses</p>
                <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-200">
                    Send personalized emails, SMS, and social media messages to your customers.
                </p>
                </div>
            </a>
            <a class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="/solutions/marketing-agencies/">
                <svg class="flex-shrink-0 w-6 h-6 mt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z" />
                </svg>              
                <div class="grow">
                <p class="font-medium text-gray-800 dark:text-gray-200">Agenceis</p>
                <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-200">
                    Manage multiple clients and campaigns from a single dashboard.
                </p>
                </div>
            </a>

            <a class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="/solutions/enterprise">
                <svg class="flex-shrink-0 w-6 h-6 mt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
                </svg>              
                <div class="grow">
                <p class="font-medium text-gray-800 dark:text-gray-200">Enterprise</p>
                <p class="text-sm text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-200">
                    Scale your marketing efforts with advanced features and integrations.
                </p>
                </div>
            </a>            
            </div>
        ...
        <div class="col-span-full md:col-span-5">
          <div class="flex flex-col bg-gray-50 p-6">
            <span class="text-xs font-semibold uppercase text-gray-800 dark:text-gray-200">Join our Agency Partner Program</span>

            <a class="mt-4 group" href="/agency-partner-program/">
              ...
              <div class="mt-2">
                ...
                <a class="mt-3 py-3 px-4 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800" href="/agency-partner-program/">
                    Become a partner
