...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Pricing That Makes Sense</h2>
    <h3 class="mt-3 text-xl text-gray-600 dark:text-gray-400">Flexible pricing to meet your needs</h3>
  </div>
  <!-- End Title -->
  
  <!-- Description -->
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <p class="mt-4 text-xl text-gray-800">Steer Campaign is the first managed Mautic provider that offers a usage-based pricing model, which means that you only pay for what you use. </p>
  </div>
  <!-- End Description -->
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
      <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">Getting Started</h4>
      <span class="mt-7 font-bold text-5xl text-gray-800 dark:text-gray-200">Free Trial</span>
      <p class="mt-2 text-sm text-gray-500">14 days free</p>
    ...
    <!-- Card -->
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
      <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">Self Service</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-gray-200">
        <span class="font-bold text-2xl -mr-2">$</span>
        50
      </span>
      <p class="mt-2 text-sm text-gray-500">Managed Mautic installation</p>
    ...
    <div class="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
      ...
      <p class="mt-2 text-sm text-gray-500">Managed Mautic with managed email serivce</p>
    ...
    <!-- Card -->
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
      <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">Custom Solutions</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-gray-200">
        <span class="font-bold text-2xl -mr-2">$</span>
        600
      </span>
      <p class="mt-2 text-sm text-gray-500">Unlock premium performance, enterprise-grade security, and priority support.</p>
  ...
  <div class="mt-20 lg:mt-32">
    <div class="lg:text-center mb-10 lg:mb-20">
      <h3 class="text-2xl font-semibold dark:text-white">Steer Campaign vs. the Competition: A Quick Comparison</h3>
    </div>    
    @include('_partials.pricing.table-lg')
    
    <div class="lg:text-center mb-10 lg:mb-20">
      <a class="text-2xl font-semibold dark:text-white" target="_blank" href="/Steer_Campaign_Feature_Comparision.pdf">Download the full comparison sheet</a>      
    </div>    
  </div>
  <!-- End Grid --> 
</div>
