...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <div class="flex flex-col sm:col-start-1 lg:col-start-2 lg:col-span-2 text-center">
      <label for="hs-select-label" class="block text-3xl font-medium mb-2 dark:text-white">How many contacts do you have?</label>
      <select id="hs-select-label" class="py-3 px-4 pr-9 block border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
