...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
            <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">{{$sub_header}}</p>
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">{{$header}}</h1>
            <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">{{$desc}}</p>
        ...
        <img class="w-full rounded-md" src="{{$image}}" alt="{{$alt}}">        
