...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        ...
        <img class="w-full rounded-md" src="/assets/images/partner-program/partner-program.jpeg" alt="Mautic helps enterprises with their marketing automation needs.">
    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <h2 class="text-3xl text-gray-800 font-bold lg:text-4xl dark:text-white text-center">
                Why Join Our Agency Partner Program?
            </h2>
            <p class="mt-3 text-gray-800 dark:text-gray-400">
                Are you looking to expand your horizons, boost revenue, and offer your clients cutting-edge marketing solutions? Look no further. We're thrilled to announce that we're in the process of creating an exciting new Agency Partner Program that will empower agencies like yours to thrive in the digital marketing landscape.
            </p>
        </div>
        ...
        <div class="space-y-6 lg:space-y-10">
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Gain a competitive edge and foster agency growth with our exclusive benefits, including early feature access and priority support for exceptional client solutions.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Access expertise and resources to sharpen your agency's skills and expand your service offerings. Our program will provide access to training, best practices, and a community of like-minded professionals.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Expand your revenue streams by offering our industry-leading solutions to your clients. Our partner program is designed to help you drive more value for your clients while boosting your agency's profitability.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
        ...
        <div class="space-y-6 lg:space-y-10">
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Forge valuable partnerships and network with fellow program agencies, unlocking new opportunities, shared knowledge, and enhanced growth through collaboration.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">                
                Stay at the forefront of marketing technology by gaining early access to our latest innovations and product updates. Your agency will be among the first to leverage cutting-edge features and tools.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
          ...
          <div class="flex">
            ...
            <div class="ml-5 sm:ml-8">
              ...
              <p class="mt-1 text-gray-600 dark:text-gray-400">
                Count on priority support to ensure your clients' needs are met promptly and effectively. Our team is here to assist you every step of the way, providing the support you need to deliver outstanding results.
              </p>
            </div>
          </div>
          <!-- End Icon Block -->
